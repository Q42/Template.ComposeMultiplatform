...
sealed class NavigationState {
    ...
    data class PopToDestination(val destination: Destination, val id: String = Uuid.random().toString()) : NavigationState()

    data class NavigateUp(val id: String = Uuid.random().toString()) : NavigationState()
}
