 ...
 * executes the call, and maps the result to an ActionResult with proper error handling.
 *
    ...
    return try {
        ...
        when (e.response.status.value) {
            ...
            HTTP_TOO_MANY_REQUESTS -> {
                ActionResult.Error.TooManyRequests(throwable = e)
            }

            else -> {
                ActionResult.Error.Other(
